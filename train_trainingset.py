...
annotation_fpath= '/home/l.leek/src/CellDetect/IID/annotations/train_mrr.txt'
...
#save model
print("save model")
learner.save_model_state('/home/l.leek/src/CellDetect/IID/weights/trained_weights_trainingset.pkl')
