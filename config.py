...
## initialization
cd_model_path = '/data/lindsay/HECellClassification/IID/cell_detection_weights.pkl'
cc_model_path = '/data/lindsay/HECellClassification/IID/cell_classification_weights.pkl'
cd_sample_size = 256
cc_sample_size = 256
cd_mb_size = 32
cc_mb_size = 128
...
api_token_path = '/data/lindsay/HECellClassification/IID/IID_slidescore_training.key'
