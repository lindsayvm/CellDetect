...
<<<<<<< HEAD
with open('IID/output_mask/T19_07579_II6_HE_2class_tumor_img386688.json', 'w') as f:
    f.write(exjson)
...
<<<<<<< HEAD
with fiona.open('IID/output_mask/T19_07579_II6_HE_2class_tumor_img386688.shp', 'w', 'ESRI Shapefile', schema) as c:
=======
